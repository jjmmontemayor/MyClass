...
while($l = $dbconn->fetch_row($locationdec))
{
	...
	$html.="</table><br/>";	
	$html.= "<table cellpadding='2' frame='box'><tr><td colspan='5' style='text-align:left;background:#CC9990;font-size:15px'>SUMMARY OF COURSES WITH NO TEACHERS</th></tr>";
...
$html.= "<br /><table cellpadding='2' frame='box'><tr><td colspan='5' style='text-align:left;background:#CC9990;font-size:15px'>SUMMARY OF UNALLOCATED COURSES</th></tr>";
...
//summary of unallocated rooms
	...
	$html.= "<br /><table cellpadding='2' frame='box'><tr><td colspan='5' style='text-align:left;background:#CC9990;font-size:15px'>SUMMARY OF UNALLOCATED ROOMS</th></tr>";
