...
<?php	
	while($result_facultydesc = $dbconn->fetch_row($facultydesc))
	{
		...
		$querysched = "SELECT * FROM schedule_details WHERE facultyid = ".$facultyid;
		$sched = $dbconn->query($querysched);
		
			
		$html.= "<br /><table cellpadding='2' frame='box'><tr><td colspan='5' style='text-align:left;background:#CC9990;font-size:15px'>Faculty Name: <b>".$result_facultydesc[1]."</b></th></tr>";
