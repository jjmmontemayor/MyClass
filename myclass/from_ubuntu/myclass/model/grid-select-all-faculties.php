...
function GridSelectAllFaculties($start, $limit) 
{
	...
	$query = "SELECT f.facultyid, f.faculty_desc, d.department_desc, f.faculty_maxload, f.faculty_minload, f.faculty_targetload, c.college_desc, d.department_desc,f.faculty_preftime, f.faculty_prefloc, f.faculty_teachables FROM faculties f, colleges c, departments d WHERE c.collegeid = f.faculty_college AND d.departmentid = f.faculty_department ORDER BY faculty_desc ASC LIMIT ".$limit." OFFSET ".$start;
